function [M9 T9 u9 A9 m9]=solveNozzle2(T5,xi5,p0,p5,M5,T9_1,A5)
S5tot=0;
H9tot=0;
H5tot=0;
...
diff=S9tot-xi5(1)*Ru*(a(4,1)*log(x)+a(4,2)*x+a(4,3)*x^2/2+a(4,4)*x^3/3+a(4,5)*x^4/4+a(4,7))...
